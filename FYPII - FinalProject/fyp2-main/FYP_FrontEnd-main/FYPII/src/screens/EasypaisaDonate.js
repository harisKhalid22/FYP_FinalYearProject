...
import EasypaisaButton from "../components/EasypaisaButton";
import EasypaisaHeader from "../components/EasypaisaHeader";

function EasypaisaDonate(props) {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.image1Stack}>
        ...
        ></TextInput>
        <EasypaisaButton style={styles.cupertinoButtonInfo6}></EasypaisaButton>
      </View>
      <EasypaisaHeader style={styles.materialHeader11}></EasypaisaHeader>
    </View>
  );
}
...
export default EasypaisaDonate;
